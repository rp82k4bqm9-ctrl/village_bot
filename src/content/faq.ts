...
export const DEFAULT_FAQ_CONTENT: FaqContentByCategory = {
  delivery: [
    ...
    },
    {
      ...
      a: 'Цифровые коды отправляются мгновенно после оплаты. Активация аккаунтов занимает до 30 минут в рабочее время (пн-пт 11:00-01:00, сб-вс 12:00-02:00 МСК).',
    },
    {
  ...
  support: [
    ...
    },
    {
      ...
      a: 'В среднем ответ приходит в течение 15-30 минут в рабочее время (пн-пт 11:00-01:00, сб-вс 12:00-02:00 МСК). В пиковые часы может занять до 2 часов.',
    },
    {
